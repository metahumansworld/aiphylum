...
func BuilderPrompt(current Agent) string {
	...
	b.WriteString("\nThe agent may also be woken by events the person's systems send it.\n")
	b.WriteString("\"webhook\": {\"instruction\": \"what an event is and what to do with one,\n")
	b.WriteString("up to 1024 bytes\"} opens that; leave it out unless they ask for it.\n")
